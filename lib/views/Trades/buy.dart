...
class StockBuyPage extends HookConsumerWidget {
  const StockBuyPage({super.key});
  @override
              ...
              Container(
                ...
                child: Center(
                  child: ToggleSwitch(
                    ...
                    activeFgColor: const Color.fromARGB(255, 3, 132, 98),
                    activeBgColor: const [
                      Color.fromARGB(255, 225, 241, 238),
                    ],
                    initialLabelIndex: 0,
                    totalSwitches: 2,
                    inactiveFgColor: const Color.fromARGB(131, 38, 38, 38),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      const Color.fromARGB(255, 225, 241, 238),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: const Padding(
                                  padding: EdgeInsets.only(left: 9.5, top: 2.5),
                                  child: Text(
                                    '+',
                                    style: TextStyle(
                                        fontSize: 22,
