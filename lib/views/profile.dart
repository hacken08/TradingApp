              ...
              Stack(children: [
                PhysicalModel(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.only(topLeft: Radius.circular(25.3), topRight: Radius.circular(25.3)),
                ...
                Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 12),
                  Padding(padding: EdgeInsets.only(left: 103.9),
                     child: Text('CLIENT ID - R6412343', style: TextStyle(fontSize: 16, color: Colors.grey, letterSpacing: 2),
                   ), 
                  ),
                  ],
                )
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Image.asset('assets/images/verfiy.png', scale: 6),
                            ), 
                      
                            Padding(
                              padding: const EdgeInsets.only(),
                              child: Text('Dp ID (DEpository Participant)', 
                              style: TextStyle(
                                fontWeight: FontWeight.w400,
                           ...
                           Padding(
                             ...
                             child: IconButton(onPressed: () {}, icon: Icon(Icons.mode_edit_outline_outlined, color: Colors.grey,)),
                           )
                          ],
                        ),
                      ),
